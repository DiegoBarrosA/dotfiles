...
(def-doom-theme doom-m0w0kai-pro
  "Custom Monokai Pro build"
  ...
  ((bg         '("#121212" nil       nil          ))
   ...
   (fg         '("#eaf2ff" "#939293" "white"))
   (fg-alt     '("#939293" "#A3A2A3" "white"))

   (grey       '("#727072" "#727072" "brightblack"))
   (red        '("#e84680" "#CC6666" "red"))
   (orange     '("#e7855a" "#FC9867" "orange"))
   (green      '("#79ffa5" "#A9DC76" "green"))
   (teal       green)
   (yellow     '("#f9ff61" "#FFD866" "yellow"))
   (blue       '("#8ab4f8" "#78DCE8" "blue"))
   (dark-blue  '("#1976D2" "#81A2BE" "blue"))
   (magenta    '("#f655c7" "#FF6188" "violet"))
   (violet     '("#9a86ff" "#AB9DF2" "violet"))
   (cyan       blue)
   (dark-cyan  dark-blue)
